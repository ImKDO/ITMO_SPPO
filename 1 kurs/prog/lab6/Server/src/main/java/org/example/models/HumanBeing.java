...
public class HumanBeing extends Element implements Validation, Serializable {
    ...
    public HumanBeing(Integer id, String name, Coordinates coordinates, Boolean realHero, Boolean hasToothpick, Double impactSpeed, LocalDateTime creationDate, String soundtrackName, WeaponType weaponType, Mood mood, Car car) {
        this.id = id;
        this.name = name;
